      ...
      <section id="reservas" className="cta">
        ...
        <div className="cta__content">
          ...
          <p className="cta__text">
            Reserva tu mesa y asegura tu lugar en una experiencia gastronómica inolvidable.
          </p>
          <div className="cta__buttons">
            ...
            <a href="tel:+56912345678" className="cta__btn cta__btn--call">
          ...
          <div className="footer__grid">
            <div className="footer__brand">
              ...
              <p className="footer__desc">
                Auténtica gastronomía peruana en Santiago. Recetas de casa, ingredientes frescos, pasión en cada plato.
              </p>
            ...
            <div className="footer__col">
              ...
              <ul className="footer__hours">
                <li><span>Lun - Jue</span><span>12:30 - 23:00</span></li>
                <li><span>Vie - Sáb</span><span>12:30 - 00:00</span></li>
                <li><span>Domingo</span><span>12:30 - 22:00</span></li>
              </ul>
            </div>
